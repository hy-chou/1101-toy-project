...
do
    ...
    ${cmd7} "*/10 00-19 ${hh} ${dd} * *" "0 30 ${hh} ${dd} * *" &
    ${cmd8} "*/10 00-19 ${hh} ${dd} * *" "0 30 ${hh} ${dd} * *" &
    ${cmd9} "*/10 00-19 ${hh} ${dd} * *" "0 30 ${hh} ${dd} * *" &
    ${cmd10} "*/10 00-19 ${hh} ${dd} * *" "0 30 ${hh} ${dd} * *" &
    ...
    ${cmd7} "*/10 20-39 ${hh} ${dd} * *" "0 50 ${hh} ${dd} * *" &
    ${cmd8} "*/10 20-39 ${hh} ${dd} * *" "0 50 ${hh} ${dd} * *" &
    ${cmd9} "*/10 20-39 ${hh} ${dd} * *" "0 50 ${hh} ${dd} * *" &
    ${cmd10} "*/10 20-39 ${hh} ${dd} * *" "0 50 ${hh} ${dd} * *" &
    ...
    if [ ${hh} != 23 ]; then
        ...
        ${cmd7} "*/10 40-59 ${hh} ${dd} * *" "0 10 $((${hh}+1)) ${dd} * *" &
        ${cmd8} "*/10 40-59 ${hh} ${dd} * *" "0 10 $((${hh}+1)) ${dd} * *" &
        ${cmd9} "*/10 40-59 ${hh} ${dd} * *" "0 10 $((${hh}+1)) ${dd} * *" &
        ${cmd10} "*/10 40-59 ${hh} ${dd} * *" "0 10 $((${hh}+1)) ${dd} * *" &
        ...
        ${cmd7} "*/10 40-59 23 ${dd} * *" "0 10 0 $((${dd}+1)) * *" &
        ${cmd8} "*/10 40-59 23 ${dd} * *" "0 10 0 $((${dd}+1)) * *" &
        ${cmd9} "*/10 40-59 23 ${dd} * *" "0 10 0 $((${dd}+1)) * *" &
        ${cmd10} "*/10 40-59 23 ${dd} * *" "0 10 0 $((${dd}+1)) * *" &
