...
while [ ! ${HH} == $((${Hn}+1)) ]
do
    ${CMD_STRM} "    0 ${HH} ${DD} * *" " 6 ${HH} ${DD} * *" > /dev/null 2>&1 &
    ${CMD_STRM} "   12 ${HH} ${DD} * *" "18 ${HH} ${DD} * *" > /dev/null 2>&1 &
    ${CMD_STRM} "   24 ${HH} ${DD} * *" "30 ${HH} ${DD} * *" > /dev/null 2>&1 &
    ${CMD_STRM} "   36 ${HH} ${DD} * *" "42 ${HH} ${DD} * *" > /dev/null 2>&1 &
    ${CMD_STRM} "   48 ${HH} ${DD} * *" "54 ${HH} ${DD} * *" > /dev/null 2>&1 &
