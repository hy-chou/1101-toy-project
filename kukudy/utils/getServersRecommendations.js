...
if (require.main === module) {
  ...
  const countryNum = countryCodes[country];

  if (countryNum === undefined) {
  ...
  axios.get('https://nordvpn.com/wp-admin/admin-ajax.php', {
    params: {
      ...
      filters: {
        country_id: countryCodes[process.argv[2]],
        servers_technologies: [3],
      },
    },
  })
    .then((res) => res.data[0].hostname)
    .then((hostname) => console.log(hostname.slice(0, hostname.indexOf('.'))));
}
